...
<template>
  <div class="bg-white rounded-4 p-4 shadow-sm">
    ...
    <div class="w-100 d-flex rounded-3 overflow-hidden mb-4 bg-light" style="height: 32px;">
      ...
      >
        <div class="position-absolute start-50 translate-middle-x bg-dark text-white rounded z-3"
    ...
    <div class="d-flex flex-column gap-3">
      ...
      >
        ...
        />
        <span class="small fw-medium mb-0" :class="selectedCategory === item.category ? 'text-dark' : 'text-muted'">
          {{ item.category }}
        </span>
