<template>
  ...
  >
    <div
      class="bg-white rounded-4 w-100 p-4 shadow-lg"
    ...
    >
      ...
      <div class="d-flex flex-column gap-3">
        <div>
          ...
          <div class="d-flex gap-2">
            ...
            <button
              ...
              class="btn flex-grow-1 py-2 rounded-3 border-0"
              :class="
                type === 'EXPENSE' ? 'text-white' : 'btn-light text-muted'
              "
              :style="
        ...
        <div>
          ...
          <div class="row g-2">
            ...
            >
              <button
                @click="category = cat"
                class="btn w-100 py-2 rounded-3 small border-0 text-truncate"
                :class="
                  category === cat
                    ? type === 'INCOME'
                      ? 'btn-primary text-white'
        ...
        <div>
          <label class="small text-muted mb-2 d-block">메모(선택)</label>
          <textarea
            v-model="memo"
